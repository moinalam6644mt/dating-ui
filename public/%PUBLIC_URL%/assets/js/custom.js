...
$(document).ready(function(){
		...
		function mmenuInit() {
			...
			if(wi <= '991.98') {
				...
				if($('.dashboard-nav-inner').length==1){
					//var profile_name=$("#logo").find('img').attr('src', '../assets/images/logo.png');
	...
	function fullPageScrollbar() {
		$(".full-page-sidebar-inner, .dashboard-sidebar-inner").each(function() {
			...
			var headerHeight = $("#header-container").outerHeight();
			var windowHeight = $(window).outerHeight() - headerHeight;
			var sidebarContainerHeight = $(this).find(".sidebar-container, ._dashboard-nav-container").outerHeight();
	...
	$(window).on('load resize', function() {
		...
		$('.dashboard-footer-spacer').css({
			'padding-top': smallFooterHeight + 1
		});
	});
