...
const MyGalleryList = ({ setShow  ,myGalleryData ,imgPath}) => {

  const [currentIndex, setCurrentIndex] = useState(0);

  const PreviousValue = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? myGalleryData.length - 1 : prevIndex - 1
    );
  };

  const NextValue = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === myGalleryData.length - 1 ? 0 : prevIndex + 1
    );
  };
          ...
          <div className="mfp-content">
            <div className="mfp-figure">
              ...
              <figure>
                <img
                  className="mfp-img"
                  src={`${imgPath}${myGalleryData[currentIndex].image}`}  
                ...
                <figcaption>
                  <div className="mfp-bottom-bar">
                    ...
                    <div className="mfp-counter">
                      {currentIndex + 1} of {myGalleryData.length}
                    </div>
                  </div>
                </figcaption>
              </figure>
